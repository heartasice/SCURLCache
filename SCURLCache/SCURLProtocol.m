...
static NSString *SCURLProtocolHandled = @"SCURLProtocolHandled";

@interface SCURLProtocol()
...
+ (BOOL)canInitWithRequest:(NSURLRequest *)request {
    ...
    //防止递归
    if ([NSURLProtocol propertyForKey:SCURLProtocolHandled inRequest:request]) {
        return NO;
    }
...
- (void)startLoading {
    ...
    if (expire) {
        ...
        [NSURLProtocol setProperty:@YES forKey:SCURLProtocolHandled inRequest:newRequest];
