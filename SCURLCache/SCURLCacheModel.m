...
@implementation SCURLCacheModel

#pragma mark - For NSURLProtocol
+ (SCURLCacheModel *)shareInstance {
    static SCURLCacheModel *instance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[SCURLCacheModel alloc] init];
    });
    return instance;
}
...
- (NSString *)cacheRequestFileName:(NSString *)requestUrl {
    return [SCURLCacheModel md5Hash:[NSString stringWithFormat:@"%@",requestUrl]];
}
- (NSString *)cacheRequestOtherInfoFileName:(NSString *)requestUrl {
    return [SCURLCacheModel md5Hash:[NSString stringWithFormat:@"%@-otherInfo",requestUrl]];
}
